...
hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.exec_cmd("launch-system-menu"))
hl.bind(
	mainMod .. " + Escape",
...
-- Switch to games workspace
hl.bind(mainMod .. " + G", hl.dsp.focus({ workspace = 10 }))

-- Switch to windows workspace
hl.bind(mainMod .. " + W", hl.dsp.focus({ workspace = 9 }))
