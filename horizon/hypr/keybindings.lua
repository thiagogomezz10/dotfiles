...
hl.bind(mainMod .. " + SHIFT + code:34", hl.dsp.layout("togglesplit"))    -- dwindle only
...
hl.bind("F5", hl.dsp.exec_cmd("ddcutil setvcp 10 - 5"), { locked = true, repeating = true })
hl.bind("F6", hl.dsp.exec_cmd("ddcutil setvcp 10 + 5"), { locked = true, repeating = true })
